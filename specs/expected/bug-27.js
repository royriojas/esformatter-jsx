    ...
    return (
      <div className={ styles.widgets + ' container' }>
        <h1>Widgets <button
                            ...
                            onClick={ load }> <i className={ refreshClassName }/> { ' ' } Reload Widgets </button></h1>
        <DocumentMeta title="React Redux Example: Widgets" />
        <p>
          This data was loaded from the server before this route was rendered. If you hit refresh on your browser, the data loading will take place on the server before the
          page is returned. If you navigated here from another page, the data was fetched from the client.
        </p>
        <p>
          ...
          <table className="table table-striped">
            <thead>
              <tr>
                ...
                <th className={ styles.colorCol }>
                  Color
                </th>
                <th className={ styles.sprocketsCol }>
                  Sprockets
                </th>
